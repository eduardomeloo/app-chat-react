import { useContext, useEffect, useRef, useState, setState } from "react"
...
export default function Chat() {
    ...
    return (
        <div className="flex h-screen lg-max:flex-col">
            <div className="bg-white w-1/3 lg-max:w-full flex flex-col flex-auto">
                <div className="flex-grow">
                    ...
                    {!selectedUserId && windowSize[0] <= 960 ? (
                        <div>
            ...
            {!!selectedUserId && windowSize[0] <= 960 ? 
            (
                <div className="flex flex-col bg-blue-50 p-2 w-full h-full">
                    <div className="flex items-center cursor-pointer" onClick={() => setSelectedUserId(null)}>
                    ...
                    <div className="flex-grow">
                        {!!selectedUserId && (
                            <div className="relative h-full">
                                <div className="overflow-auto scrollbar-hide absolute top-0 left-0 right-0 bottom-2">
            ...
            : null}
            <div className="flex flex-col bg-blue-50 w-2/3 p-2 lg-max:w-full">
                <div className="flex-grow">
                    {!selectedUserId && (
